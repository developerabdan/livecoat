                ...
                <section>
                    <div class="form grid gap-6">
                        ...
                        <div class="grid gap-2">
                            ...
                            <input type="email" id="demo-card-form-email" placeholder="Enter your email" wire:model="email">
                            @error('email')<p class="text-destructive text-sm">{{ $errors->first('email') }}</p>@enderror
                        </div>
                        <div class="grid gap-2">
                            ...
                            <input type="password" id="demo-card-form-password" placeholder="Enter your password" wire:model="password">
                            @error('password')<p class="text-destructive text-sm">{{ $errors->first('password') }}</p>@enderror
                        </div>
                    </div>
                </section>
